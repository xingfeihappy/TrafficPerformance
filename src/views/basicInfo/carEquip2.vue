<template>
	<section>
		...
		<el-table>
			...
			<el-table-column type = "carNum" label = "车辆牌号" width = "120" sortable></el-table-column>
			...
			<el-table-column type = "carType" label = "车辆类型" width = "130" sortable></el-table-column>
			<el-table-column type = "carBrand" label = "车辆品牌" width = "120" sortable></el-table-column>
			<el-table-column type = "carModel" label = "车辆型号" width = "120" sortable></el-table-column>
				...
				this.$refs.addForm.validate((valid) =>{
					if(valid){
						 this.$confirm('确认增加吗？','提示',{}).then(()=>{
							...
							para.operateStartTime = (!para.operateStartTime || para.operateStartTime == '') ? '' : util.formatDate.format(new Date(para.operateStartTime), 'yyyy-MM-dd');
